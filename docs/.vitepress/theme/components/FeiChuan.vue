        ...
        <svg xmlns="http://www.w3.org/2000/svg" width="100%" height="100%" viewBox="0 0 150 51">
            ...
            <foreignObject width="100%" height="100%">
                <div xmlns="http://www.w3.org/1999/xhtml"
                    ...
                    <div style="display: inline-flex; align-items: center; margin: 0 -13px 0 -5px;"><svg
                            style="display: inline-block; width: 60px; height: 100%;" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 60 51" height="51" width="60">
                            <path stroke-dasharray="191" stroke-dashoffset="191"
                                style="animation: draw 1.9100000000000001s 0s forwards;" stroke="#000000" fill="none"
                    ...
                    <div style="display: inline-flex; align-items: center; margin: 0 -4px 0 0;"><svg
                            ...
                            <path stroke-dasharray="22" stroke-dashoffset="22"
                                style="animation: draw 0.22s 1.9100000000000001s forwards;" stroke="#000000" fill="none"
                                stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div style="display: inline-flex; align-items: center; margin: 0 -3.5px 0 0;"><svg
                            style="display: inline-block; width: 9px; height: 100%;" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 9 51" height="51" width="9">
                            <path stroke-dasharray="16" stroke-dashoffset="16"
                                style="animation: draw 0.16s 2.1300000000000003s forwards;" stroke="#000000" fill="none"
                                stroke-linecap="round" stroke-linejoin="round"
                                d="M3.7548 22.9229C2.60207 23.529 -0.752212 29.5295 1.61166 28.7618C3.97553 27.994 5.61205 25.8726 7.67374 24.721">
                            </path>
                        </svg></div>
                    <div style="width: 7px;"></div>
                    <div style="display: inline-flex; align-items: center; margin: 0 -5px 0 -6px;"><svg
                            style="display: inline-block; width: 37px; height: 100%;" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 37 51" height="51" width="37">
                            <path stroke-dasharray="101" stroke-dashoffset="101"
                                style="animation: draw 1.01s 2.2900000000000005s forwards;" stroke="#000000" fill="none"
                                stroke-linecap="round" stroke-linejoin="round"
                                d="M35.1522 7.2324C38.1612 -9.90171 5.01684 18.1833 1.44481 44.1581C-0.863382 60.9427 22.8446 32.2692 28.2295 28.4927">
                            </path>
                        </svg></div>
                    <div style="display: inline-flex; align-items: center; margin: 0 -4px 0 -1px;"><svg
                            style="display: inline-block; width: 18px; height: 100%;" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 18 51" height="51" width="18">
                            <path stroke-dasharray="48" stroke-dashoffset="48"
                                style="animation: draw 0.48s 3.3000000000000007s forwards;" stroke="#000000" fill="none"
                                stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div style="display: inline-flex; align-items: center; margin: 0 -4.5px 0 0;"><svg
                            ...
                            <path stroke-dasharray="28" stroke-dashoffset="28"
                                style="animation: draw 0.28s 3.7800000000000007s forwards;" stroke="#000000" fill="none"
                                stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div style="display: inline-flex; align-items: center; margin: 0 -4px 0 0;"><svg
                            ...
                            <path stroke-dasharray="36" stroke-dashoffset="36"
                                style="animation: draw 0.36s 4.0600000000000005s forwards;" stroke="#000000" fill="none"
                                stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div style="display: inline-flex; align-items: center; margin: 0 -5px 0 0;"><svg
                            style="display: inline-block; width: 15px; height: 100%;" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 15 51" height="51" width="15">
                            <path stroke-dasharray="27" stroke-dashoffset="27"
                                style="animation: draw 0.27s 4.420000000000001s forwards;" stroke="#000000" fill="none"
                                stroke-linecap="round" stroke-linejoin="round"
